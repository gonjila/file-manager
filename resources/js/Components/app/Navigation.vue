    ...
    <nav class="min-w-[200px]">
        ...
        <div class="px-3">
            ...
            <div class="py-3">
                ...
                <NavLink href="/" :active="$page.url === '/shared-'">Shared with me</NavLink>
                <NavLink href="/" :active="$page.url === '/shared-'">Shared by me</NavLink>
                <NavLink href="/" :active="$page.url === '/trash'">Trash</NavLink>
            </div>
        </div>
    </nav>
</template>
